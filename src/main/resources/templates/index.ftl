                ...
                <div class="card-body">
                    <div class="row padded-row">
                        <div class="col-md-12 col-sm-12 col-centered text-segment">
                            ...
                            project
                            ‘Daniel
                            Keane’. Inspired by nightlife, the mental health of others and the struggle of musicianship
                            –
                            the Keane
                            ...
                            ‘Suburban
                            Ballet’
                            in early 2019, and with an upcoming EP, there is much more on the way from Daniel Keane and
                            his
                            band...
                        </div>
                    </div>
